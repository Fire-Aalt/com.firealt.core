...
namespace FireAlt.Core.Tests
{
    public class UnsafeHeapMemoryTests
    {
        ...
        {
            var heap = new UnsafeHeapMemory(UnsafeUtility.SizeOf<int>(), 4, Allocator.Temp);
        ...
        {
            var heap = new UnsafeHeapMemory(UnsafeUtility.SizeOf<int>(), 2, Allocator.Temp);
        ...
        {
            var heap = new UnsafeHeapMemory(UnsafeUtility.SizeOf<int>(), Allocator.Temp);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => _ = new UnsafeHeapMemory(0, Allocator.Temp));
        }
    }
}
