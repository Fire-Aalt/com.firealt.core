...
namespace FireAlt.Core.Tests
{
    public class NativeHeapMemoryTests
    {
        ...
        {
            var heap = new NativeHeapMemory(UnsafeUtility.SizeOf<int>(), 4, Allocator.Temp);
        ...
        {
            var heap = new NativeHeapMemory(UnsafeUtility.SizeOf<int>(), 2, Allocator.Temp);
        ...
        {
            var heap = new NativeHeapMemory(UnsafeUtility.SizeOf<int>(), Allocator.Temp);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => _ = new NativeHeapMemory(0, Allocator.Temp));
        }
    }
}
